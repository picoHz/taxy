...
pub fn cert_list() -> Html {
    ...
    use_effect_with_deps(
        move |_| {
            let is_loading = is_loading_cloned.clone();
    ...
    html! {
        ...
        <div class="flex flex-col mb-4 px-4 lg:px-0">
            ...
            if *tab == CertsTab::Server {
                ...
                if *is_loading {
                    <svg aria-hidden="true" role="status" class="w-8 h-8 mx-auto my-7 text-gray-200 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
